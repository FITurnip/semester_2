...
<body>
    ...
    <div class="row">
        ...
        <input type="text" id="emp_name" name="emp_name" placeholder="Employee name.."  value="<?php echo $old_employee['name'] ?>" disabled>
        </div>
    </div>
    <div class="row">
        <div class="col-25">
        ...
        <div class="col-75">
            <select id="dept" name="dept_id" disabled>
            <?php 
    ...
    <div class="row">
        ...
        <div class="col-75">
            <select id="job_level" name="job_level_id" disabled>
                <?php 
    ...
    <div class="row">
        ...
        <div class="col-75">
        <input type="number" id="year_hired" name="year_hired" placeholder="Enter year hired.." value="<?php echo $old_employee['year_hired'] ?>" disabled>
        </div>
    </div>
    <br>
    <div class="row">
